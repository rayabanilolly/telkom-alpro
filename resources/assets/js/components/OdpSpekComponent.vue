                    	...
                    	<div class="card-body">
                    		<div class="form-horizontal">
                    			<div class="form-group row">
                    				<label for="name" class="col-sm-4 col-form-label">Spek ODP</label>
                    				<div class="col-sm-8">
    ...
    export default {
        ...
        methods: {
        	...
        	saveForm()
        	{
        		...
        		this.loading = true
        		axios.post('/odp-spek-save', this.formData)
        		.then(
        			response => {
