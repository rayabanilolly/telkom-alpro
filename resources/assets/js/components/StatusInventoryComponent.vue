                    	...
                    	<div class="card-body">
                    		<div class="form-horizontal">
                    			<div class="form-group row">
                    				<label for="name" class="col-sm-4 col-form-label">Status Inventory</label>
                    				<div class="col-sm-8">
    ...
    export default {
        ...
        methods: {
        	...
        	deleteData(id) 
        	{
        		...
        		{
        			this.loading = true
	        		axios.get('/status-inventory-delete/' + id)
	        		.then(
	        			response => {
	        				alert('Data berhasil dihapus!');
	        				this.getStatusInventory();
	        				this.loading = false;
	        			}
	        		)
	        		.catch(
        	...
        	saveForm()
        	{
        		...
        		this.loading = true
        		axios.post('/status-inventory-save', this.formData)
        		.then(
        			response => {
			...
			getStatusInventory()
			{
				axios.get('/status-inventory-get')
				.then(
					response => {
