                    	...
                    	<div class="card-body">
                    		<div class="form-horizontal">
                    			<div class="form-group row">
                    				<label for="name" class="col-sm-4 col-form-label">Status Cons</label>
                    				<div class="col-sm-8">
    ...
    export default {
        ...
        methods: {
        	...
        	deleteData(id) 
        	{
        		...
        		{
        			this.loading = true
	        		axios.get('/status-cons-delete/' + id)
	        		.then(
	        			response => {
        	...
        	saveForm()
        	{
        		...
        		this.loading = true
        		axios.post('/status-cons-save', this.formData)
        		.then(
        			response => {
