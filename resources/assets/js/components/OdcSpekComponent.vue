                    	...
                    	<div class="card-body">
                    		<div class="form-horizontal">
                    			<div class="form-group row">
                    				<label for="name" class="col-sm-4 col-form-label">ODC Spek</label>
                    				<div class="col-sm-8">
    ...
    export default {
        ...
        methods: {
        	...
        	saveForm()
        	{
        		...
        		this.loading = true
        		axios.post('/odc-spek-save', this.formData)
        		.then(
        			response => {
