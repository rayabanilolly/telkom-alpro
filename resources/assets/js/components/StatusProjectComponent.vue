                    	...
                    	<div class="card-body">
                    		<div class="form-horizontal">
                    			<div class="form-group row">
                    				<label for="name" class="col-sm-4 col-form-label">Status Project</label>
                    				<div class="col-sm-8">
    ...
    export default {
        ...
        methods: {
        	...
        	deleteData(id) 
        	{
        		...
        		{
        			this.loading = true
	        		axios.get('/status-project-delete/' + id)
	        		.then(
	        			response => {
        	...
        	saveForm()
        	{
        		...
        		this.loading = true
        		axios.post('/status-project-save', this.formData)
        		.then(
        			response => {
